...
def train_model(X, Y, learning_rate=0.1, epochs=500):
    ...
    with open('fashion_model_parameters.pkl', 'wb') as f:
        pickle.dump(model_parameters, f)
    print("Fashion MNIST model trained and saved.")

def load_model_and_predict(test_images_flat, test_labels, num_images=5):
    # Load the model parameters
    model_file = 'fashion_model_parameters.pkl'
    ...
    print("Fashion MNIST model loaded.")
